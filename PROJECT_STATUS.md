...
- **Registre de pratique** : `StatsView` privilégie désormais une seule carte essentielle, avec `Temps total` comme métrique dominante et le reste des repères en lecture secondaire. Les enrichissements S8 (`heatmap`, détail de séance) restent explicitement hors périmètre
